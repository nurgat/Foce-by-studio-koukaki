...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="#story" class="story fade-in-trigger"> 
            <h2 class="title-background"><span data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">L'histoire</h2>
        ...
        <section id="studio" class="fade-in-trigger"> 
            <h2 class="title-background"><span data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">Studio Koukaki</span></h2>
            <div>
